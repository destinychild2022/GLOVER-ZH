...
echo "=========================================="
echo "开始合并HANDAL训练的LoRA权重到基础模型..."
echo "=========================================="

# 合并权重
python merge_handal_lora.py \
  --version="/mnt/data-oss/rap-prod-bak/GLOVER/model/Qwen-7B-VL" \
  --lora_path="/mnt/data-oss/rap-prod-bak/GLOVER/output/qwen_handal/lora_weights" \
  --save_path="/mnt/data-oss/rap-prod-bak/GLOVER/output/qwen_handal/merged_model" \
  --vision-tower="/mnt/data-oss/rap-prod-bak/GLOVER/model/clip-vit-large-patch14-2" \
  --precision="bf16"

echo "=========================================="
echo "权重合并完成"
echo "合并后的模型保存在: /mnt/data-oss/rap-prod-bak/GLOVER/output/qwen_handal/merged_model"
echo "=========================================="
