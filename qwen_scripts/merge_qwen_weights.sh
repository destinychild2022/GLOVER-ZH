...
python ../merge_weights.py \
  ...
  --weight="/mnt/data-oss/data-cpfs/GLOVER/output/vis_output3/pytorch_model.bin" \
  --save_path="/mnt/data-oss/data-cpfs/GLOVER/output/vis_output3/merged_model" \
...
echo "=========================================="
echo "权重合并完成"
echo "合并后的模型保存在: /mnt/data-oss/data-cpfs/GLOVER/output/vis_output3/merged_model"
echo "=========================================="